    ...
    <>
      ...
      <div className="blog-light">
        <article className="wrap pb-[50px] pt-20 sm:pt-24">
          ...
          {/* 70/30 Grid Layout: Article on Left, Sticky Rail on Right */}
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 xl:gap-12 lg:items-start">
            {/* Left Column (Reading content: Cover, Header, Body, Bridge) */}
            ...
            {/* Right Column (Sticky rail on desktop: Author & Offers) */}
            <aside className="hidden lg:col-span-4 lg:block sticky top-24 self-start" aria-label="Author & Operating Tools">
              <DesktopStickyRail />
            </aside>
          </div>
