...
export function BodyId() {
  return (
    <>
      ...
      <Tags items={meta.tags} />
      <Disclaimer>
        Angka performa yang dilaporkan Meta mencerminkan pengujian pada segmen platform tertentu dan bukan jaminan hasil untuk setiap akun pengiklan. Panduan ini merupakan interpretasi praktis dari sudut pandang operator.
      </Disclaimer>
    </>
  );
}
